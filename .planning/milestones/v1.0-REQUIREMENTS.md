# Requirements Archive: v1.0 修仙高压生存模拟 v1

**Archived:** 2026-03-21
**Status:** SHIPPED

v1.0 需求快照；下一里程碑请从新的 `.planning/REQUIREMENTS.md`（由 `/gsd-new-milestone` 建立）开始。
...
- [x] **SAVE-01**: 玩家可以使用本地存档保存和继续当前局进度，无需账号登录
- [x] **SAVE-02**: 玩家可以快速重开新一局，并保留“高压循环可重复体验”的节奏
- [x] **SAVE-03**: 游戏主流程在 Web 桌面与移动端均可正常操作与阅读（响应式适配）
